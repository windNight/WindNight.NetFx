...
{
    ///<inheritdoc />
    public abstract class SqlServerBase<TEntity> : SqlServerBase<TEntity, int>
    ...
    ///<inheritdoc />
    public abstract partial class SqlServerBase<TEntity, TId> : NoIdSqlServerBase<TEntity>
