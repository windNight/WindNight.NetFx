...
namespace WindNight.Extension.Dapper.Mysql
{
    ...
    public abstract partial class MySqlBase<TEntity, TId> : IPagedListRepositoryService<TEntity, TId>
    {
        ...
        public virtual IPagedList<TEntity> QueryPagedList(IQueryPageBase pageQueryBase, string whereSql, IDictionary<string, object> paramDict = null, string orderby = "", bool tableNameToLower = true, bool tableNameAppendPlural = true, long warnMs = -1, Action<Exception, string> execErrorHandler = null)
        {
        ...
        public virtual async Task<IPagedList<TEntity>> QueryPagedListAsync(IQueryPageBase pageQueryBase, string whereSql, IDictionary<string, object> paramDict = null, string orderby = "", bool tableNameToLower = true, bool tableNameAppendPlural = true, long warnMs = -1, Action<Exception, string> execErrorHandler = null)
        {
        ...
        /// <returns></returns>
        public virtual IPagedList<TEntity> QueryPagedList(IQueryPageInfo pagedInfo, IDictionary<string, object> parameters, long warnMs = -1, Action<Exception, string> execErrorHandler = null)
        {
        ...
        /// <param name="parameters"></param>
        /// <returns></returns>
        public virtual async Task<IPagedList<TEntity>> QueryPagedListAsync(IQueryPageInfo pagedInfo, IDictionary<string, object> parameters, long warnMs = -1, Action<Exception, string> execErrorHandler = null)
        {
        ...
        public virtual IPagedList<TEntity> QueryPagedList(string connStr, IQueryPageBase pageQueryBase, string whereSql, IDictionary<string, object> paramDict = null, string orderby = "", bool tableNameToLower = true, bool tableNameAppendPlural = true, long warnMs = -1, Action<Exception, string> execErrorHandler = null)
        {
        ...
        public virtual async Task<IPagedList<TEntity>> QueryPagedListAsync(string connStr, IQueryPageBase pageQueryBase, string whereSql, IDictionary<string, object> paramDict = null, string orderby = "", bool tableNameToLower = true, bool tableNameAppendPlural = true, long warnMs = -1, Action<Exception, string> execErrorHandler = null)
        {
        ...
        /// <param name="parameters"></param>
        /// <returns></returns>
        public virtual IPagedList<TEntity> QueryPagedList(string connStr, IQueryPageInfo pagedInfo, IDictionary<string, object> parameters, long warnMs = -1, Action<Exception, string> execErrorHandler = null)
        {
        ...
        /// <param name="parameters"></param>
        /// <returns></returns>
        public virtual async Task<IPagedList<TEntity>> QueryPagedListAsync(string connStr, IQueryPageInfo pagedInfo, IDictionary<string, object> parameters, long warnMs = -1, Action<Exception, string> execErrorHandler = null)
        {
        ...
        /// <param name="execErrorHandler"></param>
        /// <returns></returns>
        public virtual IPagedList<T> QueryPagedEList<T>(IQueryPageInfo pagedInfo, IDictionary<string, object> parameters, long warnMs = -1, Action<Exception, string> execErrorHandler = null)
            where T : class, new()
        {
        ...
        /// <param name="execErrorHandler"></param>
        /// <returns></returns>
        public virtual async Task<IPagedList<T>> QueryPagedEListAsync<T>(IQueryPageInfo pagedInfo, IDictionary<string, object> parameters, long warnMs = -1, Action<Exception, string> execErrorHandler = null)
            where T : class, new()
        {
        ...
        /// <param name="execErrorHandler"></param>
        /// <returns></returns>
        public virtual IPagedList<T> QueryPagedEList<T>(string connStr, IQueryPageInfo pagedInfo, IDictionary<string, object> parameters, long warnMs = -1, Action<Exception, string> execErrorHandler = null)
            where T : class, new()
        {
        ...
        /// <param name="execErrorHandler"></param>
        /// <returns></returns>
        public virtual async Task<IPagedList<T>> QueryPagedEListAsync<T>(string connStr, IQueryPageInfo pagedInfo, IDictionary<string, object> parameters, long warnMs = -1, Action<Exception, string> execErrorHandler = null)
            where T : class, new()
        {
        ...
        public virtual IPagedList<TEntity> QueryPagedList(int pageIndex, int pageSize, string condition, string orderBy, IDictionary<string, object> parameters = null, string queryTableName = "", long warnMs = -1, Action<Exception, string> execErrorHandler = null)
        {
        ...
        /// <returns></returns>
        [Obsolete("Please Use IQueryPageBase or IQueryPageInfo ")]
        public virtual async Task<IPagedList<TEntity>> QueryPagedListAsync(int pageIndex, int pageSize, string condition, string orderBy, IDictionary<string, object> parameters = null, string queryTableName = "", long warnMs = -1, Action<Exception, string> execErrorHandler = null)
        {
        ...
        [Obsolete("Please Use IQueryPageBase or IQueryPageInfo ")]
        public virtual IPagedList<T> QueryPagedEList<T>(int pageIndex, int pageSize, string condition, string orderBy, IDictionary<string, object> parameters = null, string queryTableName = "", long warnMs = -1, Action<Exception, string> execErrorHandler = null)
            where T : class, new()
        {
        ...
        /// <returns></returns>
        [Obsolete("Please Use IQueryPageBase or IQueryPageInfo ")]
        public virtual async Task<IPagedList<T>> QueryPagedEListAsync<T>(int pageIndex, int pageSize, string condition, string orderBy, IDictionary<string, object> parameters = null, string queryTableName = "", long warnMs = -1, Action<Exception, string> execErrorHandler = null)
            where T : class, new()
        {
        ...
        public virtual IPagedList<T> QueryPagedEList<T>(IQueryPageBase pagedInfo, string condition, string orderBy, IDictionary<string, object> parameters = null, string queryTableName = "", long warnMs = -1, Action<Exception, string> execErrorHandler = null)
            where T : class, new()
        {
        ...
        /// <returns></returns>
        [Obsolete("Please Use rewrite func  ", true)]
        public virtual async Task<IPagedList<T>> QueryPagedEListAsync<T>(IQueryPageBase pagedInfo, string condition, string orderBy, IDictionary<string, object> parameters = null, string queryTableName = "", long warnMs = -1, Action<Exception, string> execErrorHandler = null)
            where T : class, new()
        {
        ...
        /// <returns></returns>
        [Obsolete("Please Use rewrite func  ", true)]
        public virtual async Task<IPagedList<TEntity>> QueryPagedListAsync(IQueryPageBase pagedInfo, string condition, string orderBy, IDictionary<string, object> parameters = null, string queryTableName = "", long warnMs = -1, Action<Exception, string> execErrorHandler = null)
        {
        ...
        /// <returns></returns>
        [Obsolete("Please Use rewrite func  ", true)]
        public virtual IPagedList<TEntity> QueryPagedList(IQueryPageBase pagedInfo, string condition, string orderBy, IDictionary<string, object> parameters = null, string queryTableName = "", long warnMs = -1, Action<Exception, string> execErrorHandler = null)
        {
