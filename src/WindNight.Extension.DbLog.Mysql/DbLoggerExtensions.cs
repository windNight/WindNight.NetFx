...
namespace WindNight.Extension.Logger.Mysql.DbLog
{
    public static class DbLoggerExtensions
    {
        ...
        private static void SetDbLoggerProcessor(IServiceCollection services, IDbLoggerProcessor loggerProcessor = null)
        {
        ...
        public static void UseDbLoggerProcessor(this IServiceCollection services)
        {
