...
namespace WindNight.Config.Extensions
{
    ...
    public partial class ConfigController
    {
        ...
        protected virtual string GetUserAgentValue()
        {
            return Request.GetUserAgentValue();
        }

        protected virtual string GetAppTokenValue()
        {
            return Request.GetAppTokenValue();
        }

        protected virtual string GetAuthorizationValue()
        {
            return Request.GetAuthorizationValue();
        }

        protected virtual string GetRequestAppCodeValue()
        {
            return Request.GetAppCodeValue();
        }

        protected virtual string GetRequestAppNameValue()
        {
            return Request.GetAppNameValue();
        }

        protected virtual long GetRequestTsValue()
        {
            return Request.GetTimestampValue();
        }
