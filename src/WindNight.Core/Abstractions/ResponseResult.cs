...
namespace WindNight.Core
{
    ...
    public partial class ResponseResult
    {
        ...
        public static ResponseResult<T> GenSystemErrorRes<T>(string message) =>
            new ResponseResult<T>().SystemError(message);
        ...
        public static ResponseResult GenBadRes(int code, string message) =>
            new ResponseResult().BadRequest(code, message);

        public static ResponseResult<T> GenBadRes<T>(int code, string message) =>
            new ResponseResult<T>().BadRequest(code, message);
