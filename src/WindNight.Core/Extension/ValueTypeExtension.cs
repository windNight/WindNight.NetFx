...
namespace WindNight.Core.Extension
{
    public static class ValueTypeExtension
    {
        ...
        /// <returns>
        ///     The smallest integral value that is greater than or equal to <paramref name="data" />. Note that this method
        ///     returns a <see cref="T:System.Decimal" /> instead of an integral type.
        /// </returns>
        ...
        /// <returns>
        ///     The number nearest to <paramref name="data" /> that contains a number of fractional digits equal to
        ...
        /// <param name="data">A decimal number.</param>
        /// <returns>
        ///     The largest integral value less than or equal to <paramref name="data" />.  Note that the method returns an
        ///     integral value of type <see cref="T:System.Decimal" />.
        /// </returns>
        ...
        /// <returns>
        ///     The integral part of <paramref name="data" />; that is, the number that remains after any fractional digits
        ///     have been discarded.
        /// </returns>
        ...
        /// <returns>
        ///     The smallest integral value that is greater than or equal to <paramref name="data" />. Note that this method
        ///     returns a <see cref="F:System.Double.NaN" />, <see cref="F:System.Double.NegativeInfinity" />, or
        ///     <see cref="F:System.Double.PositiveInfinity" />, that value is returned. Note that this method returns a
        ///     <see cref="T:System.Double" /> instead of an integral type.
        /// </returns>
        ...
        /// <returns>
        ///     The largest integral value less than or equal to <paramref name="data" />. If <paramref name="data" /> is
        ///     equal to <see cref="F:System.Double.NaN" />, <see cref="F:System.Double.NegativeInfinity" />, or
        ///     <see cref="F:System.Double.PositiveInfinity" />, that value is returned.
        /// </returns>
        ...
        /// <param name="data">A number to truncate.</param>
        /// <returns>
        ///     The integral part of <paramref name="data" />; that is, the number that remains after any fractional digits have
        ///     been discarded, or one of the values listed in the following table.
        ///     <paramref name="data" /> Return value
        ///     <see cref="F:System.Double.NaN" /><see cref="F:System.Double.NaN" /><see cref="F:System.Double.NegativeInfinity" />
        ///     <see cref="F:System.Double.NegativeInfinity" /><see cref="F:System.Double.PositiveInfinity" />
        ...
        ///     Returns the smallest integral value that is greater than or equal to the specified double number.
        /// </summary>
        /// <param name="data">A float number.</param>
        /// <returns>
        ///     The smallest integral value that is greater than or equal to <paramref name="data" />. Note that this method
        ///     returns a <see cref="F:System.Double.NaN" />, <see cref="F:System.Double.NegativeInfinity" />, or
        ///     <see cref="F:System.Double.PositiveInfinity" />, that value is returned. Note that this method returns a
        ///     <see cref="T:System.Double" /> instead of an integral type.
        /// </returns>
        public static int Ceiling(this float data)
        {
            return (int)Math.Ceiling(data);
        }
        ...
        ///     <paramref name="digits" /> is less than 0 or greater than 15.
        /// </exception>
        public static int Round(this float data, int digits)
        {
            return (int)Math.Round(data, digits);
        }
        ...
        ///     <see cref="F:System.Double.PositiveInfinity" />, that value is returned.
        /// </returns>
        public static int Floor(this float data)
        {
            return (int)Math.Floor(data);
        }
        ...
        ///     <see cref="F:System.Double.PositiveInfinity" />
        /// </returns>
        public static int Truncate(this float data)
        {
            return (int)Math.Truncate(data);
        }
