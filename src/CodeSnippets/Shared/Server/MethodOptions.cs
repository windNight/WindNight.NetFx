    ...
    internal sealed class MethodOptions
    {
            ...
            CompressionLevel? responseCompressionLevel)
        {
            ...
            if (ResponseCompressionAlgorithm != null)
                if (!CompressionProviders.TryGetValue(ResponseCompressionAlgorithm, out _))
        ...
        /// <summary>
        ///     Creates method options by merging together the settings the specificed <see cref="GrpcServiceOptions" />
        ///     collection.
        ...
        ///     A collection of <see cref="GrpcServiceOptions" /> instances, arranged in ascending order
        ///     of precedence.
        /// </param>
        /// <returns>
        ///     A new <see cref="MethodOptions" /> instanced with settings merged from specifid
        ///     <see cref="GrpcServiceOptions" /> collection.
        /// </returns>
        public static MethodOptions Create(IEnumerable<GrpcServiceOptions> serviceOptions)
        {
            ...
            foreach (var interceptor in tempInterceptors) interceptors.Add(interceptor);

            return new MethodOptions
            (
                resolvedCompressionProviders,
                interceptors,
                maxSendMessageSize,
        ...
        private static void AddCompressionProviders(Dictionary<string, ICompressionProvider> resolvedProviders,
