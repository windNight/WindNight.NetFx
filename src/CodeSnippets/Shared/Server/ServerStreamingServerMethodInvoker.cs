...
namespace GRpc.Shared.Server
{
    ...
    internal sealed class
        ServerStreamingServerMethodInvoker<TService, TRequest, TResponse> : ServerMethodInvokerBase<TService, TRequest,
            TResponse>
        ...
        where TService : class
    {
        ...
        public async Task Invoke(HttpContext httpContext, ServerCallContext serverCallContext, TRequest request,
