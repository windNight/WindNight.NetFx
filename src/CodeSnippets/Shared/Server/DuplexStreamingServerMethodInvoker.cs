...
namespace GRpc.Shared.Server
{
    ...
    internal sealed class
        DuplexStreamingServerMethodInvoker<TService, TRequest, TResponse> : ServerMethodInvokerBase<TService, TRequest,
            TResponse>
        ...
        where TService : class
    {
        ...
        private async Task ResolvedInterceptorInvoker(IAsyncStreamReader<TRequest> requestStream,
            IServerStreamWriter<TResponse> responseStream, ServerCallContext resolvedContext)
        {
